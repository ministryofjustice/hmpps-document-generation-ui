...
Our security policy is located [here](https://github.com/ministryofjustice/hmpps-document-generation-ui/security/policy).
...
`git remote add template https://github.com/ministryofjustice/hmpps-document-generation-ui`
